...
class TestSolicitudWorkflow:
    ...
    async def test_create_solicitud(
        ...
        wh_aux = Warehouse(
            id=uuid.uuid4(), code="AUX", name="Aux", warehouse_type="auxiliar"
        )
        wh_princ = Warehouse(
    ...
    async def test_full_workflow(
        ...
        wh_aux = Warehouse(
            id=uuid.uuid4(), code="AUX2", name="Aux2", warehouse_type="auxiliar"
        )
        wh_princ = Warehouse(
    ...
    async def test_partial_receive(
        ...
        wh_aux = Warehouse(
            id=uuid.uuid4(), code="AUX3", name="Aux3", warehouse_type="auxiliar"
        )
        wh_princ = Warehouse(
...
class TestSolicitudValidation:
    ...
    async def test_rejects_origen_principal(
        ...
        wh_aux = Warehouse(
            id=uuid.uuid4(), code="AUX-V", name="Aux", warehouse_type="auxiliar"
        )
        wh_princ = Warehouse(
    ...
    async def test_rejects_mecanico_box_as_origin(
        ...
        wh_box = Warehouse(
            id=uuid.uuid4(), code="BOX", name="Box", warehouse_type="mecanico_box",
            parent_warehouse_id=uuid.uuid4(),
        )
        wh_aux = Warehouse(
            id=uuid.uuid4(), code="AUX-B", name="Aux", warehouse_type="auxiliar"
        )
    ...
    async def test_rejects_same_origin_destination(
        ...
        wh = Warehouse(
            id=uuid.uuid4(), code="SAME", name="Same", warehouse_type="auxiliar"
        )
    ...
    async def test_rejects_empty_lines(
        ...
        wh_aux = Warehouse(
            id=uuid.uuid4(), code="AUX-E", name="Aux", warehouse_type="auxiliar"
        )
        wh_princ = Warehouse(
