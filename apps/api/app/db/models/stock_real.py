...
class InventarioStockReal(Base):
    ...
    __table_args__ = (CheckConstraint("cantidad >= 0", name="cantidad_non_negative"),)
    ...
    cantidad: Mapped[Decimal] = mapped_column(Numeric(14, 2), nullable=False, default=Decimal("0"))
